...
- **Urgencia por vencimiento < 48h anula el nivel activo:** todo compromiso con vencimiento en menos de 48 horas se marca urgente y dispara notificación inmediata, sin importar el nivel de servicio calculado (incluso en Nivel 1). Esta ventana de urgencia es la *aproximación* al vencimiento, no el vencimiento en sí: una vez que el compromiso vence sin resolverse, deja de contar como "urgente <48h" y su peso de urgencia en el ranking de prioridad cae a 0 de inmediato (no gradual) — ya no debe competir por los primeros lugares de la bandeja priorizada. Sigue siendo visible y accionable en «Prioridades» (que incluye compromisos vencidos) y en el conteo de "correos vencidos" del Informe; la alerta push ya se disparó cuando cruzó el umbral de 48h, antes de vencer (decisión 2026-09-04, a pedido del usuario tras detectar que compromisos VIP vencidos hace semanas quedaban empatados en el score máximo y nunca bajaban).
